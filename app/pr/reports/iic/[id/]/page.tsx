...
import { ArrowLeft, Megaphone, FileText, Calendar, DollarSign, Users, Award, ExternalLink } from 'lucide-react'
    ...
    <div className="max-w-[1200px] mx-auto space-y-12 pb-24 px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2 lg:sticky lg:top-24 h-fit">
          <PRIICAuditWrapper reportId={report.id} reportStatus={report.status} rejectionFeedback={report.rejection_feedback} />
        </div>
      </div>
    </div>
  )
