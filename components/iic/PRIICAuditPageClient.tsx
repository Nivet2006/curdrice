...
export function PRIICAuditPageClient({
  report,
  registrations,
  totalRegistered,
  totalCheckedIn,
            ...
            <section className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-blue-600 hover:underline animate-in fade-in"
                >
