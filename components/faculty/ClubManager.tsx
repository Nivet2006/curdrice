                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        {getClubLogo(parent.name) ? (
                          <img src={getClubLogo(parent.name)!} alt={parent.name} className="w-5 h-5 object-contain rounded-md bg-white p-0.5 shrink-0" />
                        ) : (
                            ...
                            >
                              <div className="flex items-center gap-1.5 min-w-0">
                                {getClubLogo(sub.name) ? (
                                  <img src={getClubLogo(sub.name)!} alt={sub.name} className="w-4 h-4 object-contain rounded bg-white p-0.5 shrink-0" />
                                ) : (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-950 p-6 rounded-[2rem] border border-zinc-150 dark:border-zinc-800 relative overflow-hidden flex items-start gap-4">
                {getClubLogo(selectedClub.name) ? (
                  <img src={getClubLogo(selectedClub.name)!} alt={selectedClub.name} className="w-12 h-12 object-contain rounded-xl bg-white p-1 border border-zinc-200 shadow-sm shrink-0" />
                ) : (
