...
export function ShowcaseMarqueeTicker({
  ...
  return (
    <div className="relative w-full py-8 overflow-hidden bg-transparent text-[#111827] dark:text-[#F8F7F2] border-y border-[#E6E8EC] dark:border-white/10 shadow-2xl select-none">
      {/* Background Glows */}
      <div
